...
export const HOTLINE = '0899012288'
export const SHOP_EMAIL = 'dodongtruongthoi@gmail.com'

export const SHOP_ADDRESS = 'Đại Bái, Gia Bình, Bắc Ninh'
export const COMPANY_NAME = 'Công ty TNHH Đồ Đồng Trường Thơi'

export const GOOGLE_MAPS_URL = 'https://maps.google.com/?q=Đại+Bái+Gia+Bình+Bắc+Ninh'
...
export const STORES = [
  {
    ...
    phone: '0899012288',
    mapUrl: 'https://maps.google.com/?q=Đại+Bái+Gia+Bình+Bắc+Ninh',
    hours: 'T2–CN: 7:00 – 20:00',
  },
] as const
